    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paiement', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='penalites', to='payments.paiementpenalite')),
        ...
        migrations.AddField(
            ...
            name='penalite',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='paiements_penalite', to='payments.penalite'),
        ),
        migrations.CreateModel(
